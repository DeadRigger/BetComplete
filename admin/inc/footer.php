...
<script>!window.jQuery && document.write(decodeURI('%3Cscript src="js/vendor/jquery-3.3.1.js"%3E%3C/script%3E'));</script>
...
<script>
    ...
    if(!document.location.hash || document.location.hash == '#home'){
        sw('template/home.php')
    }
    else if(document.location.hash == '#tracing'){
        sw('template/tracing.php')
    }
    else if(document.location.hash == '#bets'){
        sw('template/bets.php')
    }
    else if(document.location.hash == '#users'){
        sw('template/user.php')
    }
    else if(document.location.hash == '#calendar'){
        sw('template/calendar.php')
    }
    
    $('#home').on('click',function(){ sw('template/home.php')});
    $('#users').on('click',function(){ sw('template/user.php')});
    $('#calendar').on('click',function(){ sw('template/calendar.php')});
    $('#bets').on('click',function(){ sw('template/bets.php')});
    $('#tracing').on('click',function(){ sw('template/tracing.php')});
</script>
